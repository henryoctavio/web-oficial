...
const EmpresasSlider = () => {
  return (
    <div>
      <div className="bg-gradient-to-r from-[#030014] via-purple-700 to-[#030014] mt-10 sm:mt-6 md:mt-10 lg:mt-16 w-full py-8 md:py-12 flex justify-center items-center">
        <Marquee>
