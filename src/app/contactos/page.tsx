    ...
    <section className="bg-[#030014] py-16 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="primary__title mt-10">Contáctanos</h2>
          <p className="text-white mt-10">
            Escríbenos ingresando tus datos en nuestro formulario de contacto y nos comunicaremos contigo para darte un
            asesoramiento gratuito de lo que necesites.
          </p>
        </div>
